package com.lvyni.workshopmongo.config;
...
import com.lvyni.workshopmongo.dto.AuthorDTO;
import com.lvyni.workshopmongo.dto.CommentDTO;
import com.lvyni.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("21/03/2022"), new AuthorDTO(alex));
